...
- process spawn -> `/readyz` 200: **2574 ms** (includes interpreter boot, sklearn import, and `joblib.load`)
- `/healthz` -> 200 in 2.0 ms
- `/readyz`  -> 200 in 17.8 ms  `{"status":"ready","model_version":"20260908T061824666806Z-4888d94c"}`
...
|---|---|---|---|---|---|---|---|---|
| 1 | 204 | 0 | **25.5** | 39.2 | 33.9 | **55.2** | 62.9 | 333.9 |
| 4 | 289 | 0 | **35.9** | 111.0 | 104.8 | **161.0** | 329.4 | 472.2 |
| 16 | 296 | 0 | **36.0** | 440.2 | 432.7 | **558.1** | 714.6 | 893.8 |
| 64 | 339 | 0 | **35.5** | 1676.8 | 1713.4 | **2012.6** | 2338.8 | 2619.4 |

- Peak throughput observed: **36.0 req/s** at concurrency 16, p95 **558.1 ms**.
...
- SQLite path: `C:\Users\adars\Desktop\One ML\student-mental-health-data-analysis\runtime\serving-audit.sqlite3`
- Successful prediction responses in this audit: **1132**
- New SQLite records captured in this audit: **1132**
- Record count matched successful responses exactly.
